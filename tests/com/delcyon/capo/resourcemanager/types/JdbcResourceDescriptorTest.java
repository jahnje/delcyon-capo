...
public class JdbcResourceDescriptorTest extends ResourceDescriptorTest
{
    ...
    {        
        ResourceDescriptor resourceDescriptor =  TestServer.getServerInstance().getApplication().getDataManager().getResourceDescriptor(null, "jdbc:hsqldb:file:test-data/testdb/testdb");
