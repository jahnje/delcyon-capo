...
public class HttpResourceDescriptorTest extends ResourceDescriptorTest
{

	@Override
    protected ResourceDescriptor getResourceDescriptor() throws Exception
    {        
        return TestServer.getServerInstance().getApplication().getDataManager().getResourceDescriptor(null, "http://whois.arin.net/rest/net/NET-206-80-71-224-1.xml");
    }
    
	@Override
	protected String getExpectedResourceContentPrefix()
	{
		return "<?xml version='1.0'?><?xml-stylesheet";
