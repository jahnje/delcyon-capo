...
public class JWTResourcesServlet extends AbstractResourceServlet
{
	private static final String resourceJARPath = "";
	
	private final static String resourcePattern = "/wt-resources/";
	private final static String resourceFolder = "/META-INF/resources/wt-resources/";
