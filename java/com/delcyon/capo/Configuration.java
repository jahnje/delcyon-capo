...
public class Configuration
{
	...
	public enum PREFERENCE implements Preference
	{
		...
		SECURE_PORT("sport", "SECURE_PORT", "secure SSL port to listen on", "2443", new String[] { "portNumber" }),
		SERVER_PORT("sp", "SERVER_PORT", "server port to connect to. default 2442", "2442", new String[] { "portNumber" }),
		SECURE_SERVER_PORT("ssp", "SECURE_SERVER_PORT", "secure server ssl port to connect to. default 2443", "2443", new String[] { "portNumber" }),
