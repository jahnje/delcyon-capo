...
public class OpendesktopMimeDetector extends MimeDetector
{
	...
	private void init(final String mimeCacheFile)
	{
		...
		try
		{
			...
			CapoApplication.logger.fine("Registering a FileWatcher for [" + cacheFile + "]");
	...
	private InputStream getInputStream(File file)
	{
		...
		{
			CapoApplication.logger.log(Level.SEVERE, "Error getting InputStream for file [" + file.getAbsolutePath() + "]", e);
		}
		return null;
	}
